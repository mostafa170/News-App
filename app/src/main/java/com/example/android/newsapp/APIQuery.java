...
import com.example.android.newsapp.NewsApp;
...
public class APIQuery {
    ...
    static List<NewsApp> parseJson(String response) {
        ArrayList<NewsApp> listOfNews = new ArrayList<>();
        try {
            ...
            for (int i = 0; i < resultsArray.length(); i++) {
                ...
                listOfNews.add(new NewsApp(webTitle, author, url, date, section));
            }
